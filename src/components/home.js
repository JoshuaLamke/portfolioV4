...
let Home = () => {
    return (
        <div className="container d-flex flex-column align-items-center justify-content-center h-100 pt-3">
            <div className="d-flex flex-column align-items-center col-9 mb-3">
                <h1 style={{textAlign: "center"}} className="pb-3">Welcome To My Portfolio!</h1>
